...
import com.qcloud.kms.Json.JSONArray;
import com.qcloud.kms.Json.JSONObject;
...
public class KMSAccount {
     ...
     * @KeyUsage: the usage of the key default 'ENCRYPT/DECRYPT' return
     *            KeyMetadata
     **/
     ...
     * @Plaintext the data key string return CiphertextBlob the encrypted data
     *            key string
     **/
     ...
     * @EncryptionContext the json string context if you provide it here , you
     *                    must provide the same when decrypt the data return the
     *                    data string encryped
     **/
     ...
     * @EncryptionContext the json string context return the data string
     **/
     ...
     * 
     * @KeyId the custom key id return void
     **/
     ...
     * 
     * @keyid the custom key id return KeyMetadata
     **/
